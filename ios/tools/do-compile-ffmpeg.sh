...
FFMPEG_EXTRA_CFLAGS=
# FFMPEG_EXTRA_CFLAGS="$FFMPEG_EXTRA_CFLAGS -fembed-bitcode"
...
FFMPEG_EXTRA_CFLAGS_ARM=
# FFMPEG_EXTRA_CFLAGS_ARM="$FFMPEG_EXTRA_CFLAGS_ARM -mfpu=neon -mfloat-abi=hard"
# FFMPEG_EXTRA_CFLAGS_ARM="$FFMPEG_EXTRA_CFLAGS_ARM -mfpu=neon"
...
if [ "$FF_ARCH" = "i386" ]; then
    ...
    FF_XCRUN_OSVERSION="-mios-simulator-version-min=6.1"
    FFMPEG_CFG_FLAGS="$FFMPEG_CFG_FLAGS $FFMPEG_CFG_FLAGS_SIMULATOR"
    FFMPEG_EXTRA_CFLAGS="$FFMPEG_EXTRA_CFLAGS $FFMPEG_EXTRA_CFLAGS_SIMULATOR"
    ...
    FF_XCRUN_OSVERSION="-miphoneos-version-min=6.1"
    FFMPEG_CFG_FLAGS="$FFMPEG_CFG_FLAGS $FFMPEG_CFG_FLAGS_ARM"
    FFMPEG_EXTRA_CFLAGS="$FFMPEG_EXTRA_CFLAGS $FFMPEG_EXTRA_CFLAGS_ARM"
